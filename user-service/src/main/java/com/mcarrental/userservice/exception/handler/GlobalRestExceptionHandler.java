package com.mcarrental.userservice.exception.handler;

import com.mcarrental.userservice.dto.ApiErrorDTO;
...
import com.mcarrental.userservice.exception.InsufficientRightsException;
...
public class GlobalRestExceptionHandler {
    ...
    public ApiErrorDTO unauthorized(HttpServletRequest request, AuthenticationErrorException ex) {
        ApiErrorDTO error = RestUtil.apiError(request, HttpStatus.UNAUTHORIZED, ex.getMessage());
