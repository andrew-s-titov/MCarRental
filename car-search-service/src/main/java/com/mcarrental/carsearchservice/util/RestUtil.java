package com.mcarrental.carsearchservice.util;
...
public class RestUtil {
    ...
    public static ApiErrorDTO custom403Error(HttpServletRequest request) {
    ...
    public static ApiErrorDTO custom401Error(HttpServletRequest request) {
        return ApiErrorDTO.builder()
